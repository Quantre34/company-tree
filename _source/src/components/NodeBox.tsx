...
export const NodeBox = memo(NodeBoxImpl, (a, b) => (
  a.box === b.box
  && a.theme === b.theme
  && a.selected === b.selected
  && a.dropTarget === b.dropTarget
  && a.ghosting === b.ghosting
  && a.interactive === b.interactive
  && a.onSelect === b.onSelect
  && a.onAddChild === b.onAddChild
  && a.onFloatingPointerDown === b.onFloatingPointerDown
));

function NodeBoxImpl({ box, theme, selected, onSelect, onAddChild, interactive = true, onFloatingPointerDown, dropTarget, ghosting }: Props) {
  const uid = useId();
  const t = useT();
  const n = box.node;
  const style = n.style ?? {};
  ...
  return (
    ...
    >
      <title>
        ...
        {n.people.length ? t('nodebox.peopleCount', { count: n.people.length }) : ''}
      </title>
      <rect
        className="frame"
